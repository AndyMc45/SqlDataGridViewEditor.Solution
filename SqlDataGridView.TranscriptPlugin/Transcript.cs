...
namespace SqlDataGridViewEditor
{
    ...
    internal class Transcript
    {
        ...
        // studentDegreesDataRow is this student-degree row in the student-degree table
        ...
        SqlFactory transcriptSql = new SqlFactory(TaColNames.transcriptTable, 0, 0, true); // 0, 0 means no paging
